...
def token_error_rate_details_by_utterance(
    ...
    error_rate_key: str
        the output key for the token error rate (defaults to "error_rate", can
        be changed to "PER", "WER", "CER", etc)
    ...
    list
        ...
        * "num_edits": (int) Number of edits in total.
        * "num_ref_tokens": (int) Number of tokens in the reference.
        * "token_error_rate": (float) Word error rate of the utterance.
        * "insertions": (int) Number of insertions.
        * "deletions": (int) Number of deletions.
        * "substitutions": (int) Number of substitutions.
        * "alignment": If compute_alignments is True, alignment as list,
        ...
        utterance_details.update(
            {
                ...
                "num_ref_tokens": len(ref_tokens),
                error_rate_key: 100.0 * sum(ops.values()) / len(ref_tokens),
...
def wer_summary(details_by_utterance):
    ...
    details = token_error_rate_summary(details_by_utterance)
    wer_details = {
        "WER": details["token_error_rate"],
        "SER": details["sample_error_rate"],
        "num_edits": details["num_edits"],
        "num_scored_tokens": details["num_scored_tokens"],
        "num_erraneous_sents": details["num_err_samples"],
        "num_scored_sents": details["num_scored_samples"],
        "num_absent_sents": details["num_absent_samples"],
        "num_ref_sents": details["num_ref_samples"],
...
def token_error_rate_summary(details_by_utterance):
    """
    Computes summary stats from the output of details_by_utterance, simialr to
    wer_summary but for generic token sequences
    ...
    dict
        ...
        * "token_error_rate": (float) Word Error Rate.
        * "sample_error_rate": (float) Sentence Error Rate (percentage of utterances
          which had at least one error).
        * "num_edits": (int) Total number of edits.
        * "num_scored_tokens": (int) Total number of tokens in scored
          reference utterances (a missing hypothesis might still
          have been scored with 'all' scoring mode).
        * "num_err_samples": (int) Total number of samples
          which had at least one error.
        * "num_scored_samples": (int) Total number of samples
          which were scored.
        * "num_absent_samples": (int) Hypotheses which were not found.
        * "num_ref_samples": (int) Number of all reference utterances.
        * "insertions": (int) Total number of insertions.
        * "deletions": (int) Total number of deletions.
        * "substitutions": (int) Total number of substitutions.
    ...
    for dets in details_by_utterance:
        ...
        if dets["hyp_absent"]:
            num_absent_sents += 1
    wer_details = {
        "token_error_rate": 100.0 * num_edits / num_scored_tokens,
        "sample_error_rate": 100.0 * num_erraneous_sents / num_scored_sents,
        "num_edits": num_edits,
        "num_scored_tokens": num_scored_tokens,
        "num_err_samples": num_erraneous_sents,
        "num_scored_samples": num_scored_sents,
        "num_absent_samples": num_absent_sents,
        "num_ref_samples": num_ref_sents,
        "insertions": ins,
        "deletions": dels,
        "substitutions": subs,
    }
